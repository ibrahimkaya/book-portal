    ...
    <Form>
      ...
      <Form.Group>
        <Form.Input
          ...
          value={
            props.edit
              ? props.userClickData.operationType
              : props.book.operationType
          }
        ...
        <Form.Input
          name="createDate"
          value={
            props.edit ? props.userClickData.createDate : props.book.createDate
          }
        ...
        <Form.Input
          name="updateDate"
          value={
            props.edit ? props.userClickData.updateDate : props.book.updateDate
          }
